...
public class ZeroAllEncoders extends CommandBase {
  ...
  public ZeroAllEncoders(VerticalElevator verticalElevator, HorizontalElevator horizontalElevator, Intake intake,
