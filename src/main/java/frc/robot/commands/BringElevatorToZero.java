...
public class BringElevatorToZero extends CommandBase {
  ...
  public BringElevatorToZero(VerticalElevator verticalElevator, HorizontalElevator horizontalElevator, Intake intake,
