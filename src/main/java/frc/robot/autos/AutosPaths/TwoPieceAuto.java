...
public class TwoPieceAuto extends SequentialCommandGroup {
    public TwoPieceAuto(Swerve s_Swerve){
        ...
        PPSwerveControllerCommand swerveControllerCommand = 
            ...
            addCommands(
                ...
                new VerticalFirstHorizontalCommand(RobotContainer.verticalElevator, RobotContainer.horizontalElevator, RobotContainer.wrist, 1.18, -0.98, .95, true), 
                new intakeOn(0.9),
                new WaitUntil(2500),
                new intakeOff(), 
                new HorizontalFirstVerticalCommand(RobotContainer.verticalElevator, RobotContainer.horizontalElevator, RobotContainer.wrist, -0.02, -0.03, .87, true),
